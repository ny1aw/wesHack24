...
if (global.happinessV <= (maxScore/5)){
	bar_color = make_color_rgb(0xff, 0xa0, 0xa0)
} else if ( global.happinessV <= (2 * (maxScore/5)) && (happiness >  (maxScore/5))){
	bar_color = make_color_rgb(0xff, 0xd0, 0xa0)
} else if ( global.happinessV <= (3 * (maxScore/5)) && (happiness > (2 * (maxScore/5)))){
	bar_color = make_color_rgb(0xff, 0xff, 0xa0)
}  else if ( global.happinessV <= (4 * (maxScore/5)) && (happiness > (3 * (maxScore/5)))){
	bar_color = make_color_rgb(0xd0, 0xff, 0xa0)
}  else if (global.happinessV > (4 * (maxScore/5))) {
